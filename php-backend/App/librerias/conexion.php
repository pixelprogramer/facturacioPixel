...
class conexPGSeguridad
{
    ...
    {
        $config = Yaml::parseFile(__DIR__ . './../../Config/config.yml');
        $this->validacionConexion = pg_connect("host=localhost dbname=acueducto user=postgres password=root options='--client_encoding=UTF8'") or die('NO HAY CONEXION: ' . pg_last_error());
        pg_client_encoding($this->validacionConexion);
    }
